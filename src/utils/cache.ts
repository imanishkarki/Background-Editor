...
export async function saveImageData(key: string, data: ImageData): Promise<void> {
...
export async function loadImageData(key: string): Promise<ImageData | null> {
  const db = await getDB()
  return new Promise((resolve, reject) => {
